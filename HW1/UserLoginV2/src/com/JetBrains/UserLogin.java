...
public class UserLogin {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            boolean validity = login.checkValidity(validCase, validLength, validDigit, validSpecialChar);
    ...
    public boolean checkValidity(boolean caseOk, boolean lengthOk, boolean digitOk, boolean specCharOk){
        //System.out.println("checkValidity");
        boolean valid = false;
        if(caseOk && lengthOk && digitOk && specCharOk){
            valid = true;
        }
